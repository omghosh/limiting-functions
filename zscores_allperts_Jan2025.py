...
# fitness_df = fitness_df.loc[mutant_dict['Original Training'] + mutant_dict['Original Testing'], :]
...
fig, axs = plt.subplots(3, 2, figsize=(8, 6), gridspec_kw={'width_ratios': [3.5,1]})
...
for i, perturbation in enumerate(all_perturbations):
    if perturbation in oneday_zscore_avgs:
        ...
        axs[0,0].set_ylabel('1 Day Average z-score', fontsize = 12)
...
plt.tight_layout()
# plt.show()
plt.savefig('../plots/z_scores_allperts_March2025.png')
