...
for i, perturbation in enumerate(all_perturbations):
    if perturbation in oneday_zscore_avgs:
        axs[0, 0].scatter(i, oneday_zscore_avgs[perturbation], color=perturbation_colors[perturbation], s = 50)
    ...
    if perturbation in twoday_zscore_avgs:
        axs[1, 0].scatter(i, twoday_zscore_avgs[perturbation], color=perturbation_colors[perturbation], s = 50)
    ...
    if perturbation in salt_zscore_avgs:
        axs[2, 0].scatter(i, salt_zscore_avgs[perturbation], color=perturbation_colors[perturbation], s = 50)
...
for e, this_base in enumerate(['1Day', '2Day', 'Salt']):
    ...
    for i,external_base in enumerate(['1Day', '2Day', 'Salt']):
        if  this_base != external_base:
            ...
            axs[e,1].scatter(x_vals, these_scores, color=env_color_dict[external_base], alpha = 0.75, s = 50)
            j=0
...
plt.tight_layout()
# plt.show()
plt.savefig('plots/fig2d_revised.png')
