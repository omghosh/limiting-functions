...
t1_var_explained = [0.4, 0.2, 0.1, 0.05, 0.03, 0.01, 0.005, 0.001,0]
gray_part_t1 = 1-np.sum(np.array(t1_var_explained))

noise1 = np.random.randn(k+1)*0.01
noise2 = np.random.randn(k+1)*0.01

f_var_explained = t1_var_explained+ noise1
gray_part_f =  1-np.sum(np.array(f_var_explained))

t2_var_explained = t1_var_explained+noise2
...
t1_var_explained = [0.4, 0.2, 0.1, 0.05, 0.03, 0.01, 0.005, 0.001]
gray_part_t1 = 1-np.sum(np.array(t1_var_explained))
