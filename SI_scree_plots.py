...
for anc in mut_keys:
    ...
    print(f'{anc} has {len(these_mutants)} mutants')
    print(f'{num_mutants_to_cull} culled')
    print(f'{len(these_mutants)} remain')
    ...
    plt.title(f'Ancestor: {anc}, Evolution Condition: 2 Day', fontsize=14)
