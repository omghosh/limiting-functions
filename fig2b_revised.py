...
def plot_heatmap(wt_df, ancestor_dfs, environment_dict, ancestor_colors, gene_colors, 
                 vmin, vmax, num_conditions=3, figsize=(7.5 , 4.5)):
    """
...
plt.savefig('plots/fig2b_revised.pdf', dpi=600, bbox_inches='tight')
